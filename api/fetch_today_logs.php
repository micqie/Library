...
try {
    ...
    // SQL Query for all logs without date filter
    $query = "SELECT 
                l.log_id,
                l.user_schoolId,
                l.time_in,
              ...
              LIMIT 50"; // Limit to last 50 records for testing
    ...
    $formattedLogs = array_map(function($log) {
        $formatted = [
            ...
            'department_name' => $log['user_departmentId'] ?? 'N/A',
            'course_name' => $log['user_courseId'] ?? 'N/A',
